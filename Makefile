...
install: $(TARGET)
	...
	sudo cp $(TARGET) /usr/local/bin/sensornode
	@echo "Installation klar! Kör med: sensornode"

# Avinstallera programmet
uninstall:
	@echo "Avinstallerar sensornode från /usr/local/bin/..."
	sudo rm -f /usr/local/bin/sensornode
